...
- **Stale-Access-Auto-Reaper.ps1** — Automatically identifies and removes stale permissions/access  
- **SuspiciousProcessHunter.ps1** — Hunts for anomalous/suspicious running processes on endpoints  
...
- `.github/workflows/` — CI automation (if any active)
